import { AssetType } from "@/domain/types/AssetType";
...
export const assetTypeCatalog: AssetTypeCatalogItem[] = [
  {
    ...
    description:
      "Dinero inmediato: efectivo, billeteras digitales, cuentas bancarias.",
  },
  {
    id: 2,
    value: "activoFijo",
    label: "Activo Fijo",
    description:
      "Bienes físicos que se usan en el tiempo: laptop, mueble, equipo.",
  },
  {
    id: 3,
    ...
    description:
      "Inversiones con valor como criptomonedas, acciones o fondos mutuos.",
  },
  {
    id: 4,
    ...
    description:
      "Bien no físico con valor económico: marca, software, licencia.",
  },
  {
    id: 5,
    ...
    description:
      "Propiedades inmobiliarias como casas, departamentos o terrenos.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    description:
      "Consolidado de activos para balances internos, proyecciones o control contable.",
  },
  {
    id: 8,
    value: "otro",
